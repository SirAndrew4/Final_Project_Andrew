...
class TileGenerator:
    def __init__(self):
        ...
        while True:# self.tileX
            try:
                self.tileX = int(input('tileX: '))
                if tileX < -100 or tileX > 100:
                    raise ValueError #this will send it to the print message and back to the input option
            break
        except ValueError:
            print("Invalid integer. The number must be in the range of 1-10.")
            
        while True:# self.tileY
            try:
                self.tileY = int(input('tileY: '))
                if tileY < -100 or tileY > 100:
                    raise ValueError #this will send it to the print message and back to the input option
            break
        except ValueError:
            print("Invalid integer. The number must be in the range of 1-10.")
        ...
        while True:# self.tileSizeX
            try:
                self.tileSizeX = int(input('tileSizeX: '))
                if tileSizeX < -100 or tileSizeX > 100:
                    raise ValueError #this will send it to the print message and back to the input option
            break
        except ValueError:
            print("Invalid integer. The number must be in the range of 1-10.")
            
        while True:# self.tileSizeY
            try:
                self.tileSizeY = int(input('tileSizeY: '))
                if tileSizeY < -100 or tileSizeY > 100:
                    raise ValueError #this will send it to the print message and back to the input option
            break
        except ValueError:
            print("Invalid integer. The number must be in the range of 1-10.")
            
        while True:# self.tileSizeZ
            try:
                self.tileSizeZ = int(input('tileSizeZ: '))
                if tileSizeZ < -100 or tileSizeZ > 100:
                    raise ValueError #this will send it to the print message and back to the input option
            break
        except ValueError:
            print("Invalid integer. The number must be in the range of 1-10.")
        ...
        while True:# self.maxRotationX
            try:
                self.maxRotationX = int(input('maxRotationX: '))
                if maxRotationX < -100 or maxRotationX > 100:
                    raise ValueError #this will send it to the print message and back to the input option
            break
        except ValueError:
            print("Invalid integer. The number must be in the range of 1-10.")

        while True:# self.maxRotationY
            try:
                self.maxRotationY = int(input('maxRotationY: '))
                if maxRotationY < -100 or maxRotationY > 100:
                    raise ValueError #this will send it to the print message and back to the input option
            break
        except ValueError:
            print("Invalid integer. The number must be in the range of 1-10.")
            
        while True:# self.maxRotationZ
            try:
                self.maxRotationZ = int(input('maxRotationZ: '))
                if maxRotationZ < -100 or maxRotationZ > 100:
                    raise ValueError #this will send it to the print message and back to the input option
            break
        except ValueError:
            print("Invalid integer. The number must be in the range of 1-10.")
        ...
        self.rotationXMin = -80
        self.rotationXMax = 50

        self.rotationYMin = -100
        self.rotationYMax = 80

        self.rotationZMin = -100
        self.rotationZMax = 150
        ...
        self.tileSizeXMin = 20
        self.tileSizeXMax = 25

        self.tileSizeYMin = 20
        self.tileSizeYMax = 30
